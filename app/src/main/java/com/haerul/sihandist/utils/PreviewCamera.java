        ...
        public void surfaceCreated(SurfaceHolder holder) {
            ...
            try {
                if (mCamera != null) {
                    ...
                    mParams = mCamera.getParameters();
                    Camera.Size optimalPreviewSize = getBestPreviewSize(cameraParameters);
        ...
        public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
            if (mCamera != null) {
                ...
                try {
                    ...
                    Camera.Parameters params = mCamera.getParameters();
                    Camera.Size optimalPreviewSize = getBestPreviewSize(params);
                    Camera.Size optimalSize = getBestPictureSize(params);
