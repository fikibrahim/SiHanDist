...
public class HomeViewModel extends BaseViewModel {
    ...
    public HomeViewModel(Context context, ConnectionServer connectionServer, MasterRepository repository) {
    ...
    public static class ModelFactory implements ViewModelProvider.Factory {
        ...
        public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
            return (T) new HomeViewModel(context, server, repository);
        }
    }
}
