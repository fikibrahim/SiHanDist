...
public class LogC4aViewModel extends BaseViewModel<LogC4aViewModel.Navigator> {
    
    public LogC4aViewModel(Context context, ConnectionServer connectionServer, MasterRepository repository) {
        super(context, connectionServer, repository);
    }

    public LiveData<List<Inspeksi>> getAllC4a() {
        ...
        getConnectionServer().postInspeksi(Util.getToken(getContext()), object)
                .enqueue(new Callback<JsonObject>() {
                    ...
                    public void onFailure(Call<JsonObject> call, Throwable t) {
                        ...
                        inspeksi.inspeksi_uid = "C4A-000000-00000";
                        getRepository().updateInspeksi(inspeksi);
    ...
    public static class ModelFactory implements ViewModelProvider.Factory {
        ...
        public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
            return (T) new LogC4aViewModel(context, server, repository);
        }
    }
