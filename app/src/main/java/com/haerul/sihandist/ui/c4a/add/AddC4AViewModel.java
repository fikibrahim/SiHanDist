...
public class AddC4AViewModel extends BaseViewModel<AddC4AViewModel.Navigator> {
    
    public String lon = "";
    public String lat = "";
    public String snapShot = "";
    
    public AddC4AViewModel(Context context, ConnectionServer connectionServer, MasterRepository repository) {
    ...
    public static class ModelFactory implements ViewModelProvider.Factory {
        ...
        public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
            return (T) new AddC4AViewModel(context, server, repository);
        }
    }
